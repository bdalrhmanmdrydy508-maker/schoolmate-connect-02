...
export const ar = {
  ...
  auth: {
    ...
    secretCodeRequired: 'الرمز السري مطلوب فقط عند إنشاء حساب الناظر',
    ...
    waitingApproval: 'طلب التسجيل قيد المراجعة. يرجى انتظار موافقة الناظر.',
    ensureCorrectRole: 'تأكد من اختيار الدور الصحيح أو استخدم حساباً آخر',
    adminLoginFailed: 'فشل تسجيل دخول الناظر',
  ...
  roles: {
    ...
    adminDescription: 'إدارة المدرسة والأقسام والمواد وإسناد الأساتذة',
  ...
  admin: {
    ...
    adminProfileNotFound: 'لم يتم العثور على ملف الناظر',
  ...
  teacher: {
    ...
    waitForAssignments: 'انتظر طلبات الإسناد من الناظر',
    myFiles: 'ملفاتي',
    ...
    lessonTypeHomeworkCorrection: 'تصحيح الفرض',
    lessonTypeTestCorrection: 'تصحيح اختبار',
    lessonTypeDutyCorrection: 'تصحيح واجب',
    lessonTypeLabWork: 'عمل مخبري',
    homeworkSubmissionDate: 'تاريخ تسليم الواجب',
    homeworkReturnDate: 'تاريخ إرجاع الواجب',
